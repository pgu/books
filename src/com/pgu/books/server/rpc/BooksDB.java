...
public class BooksDB {
    ...
    private static void fillFsillon() {
        ...
        b.add(new Book("Prólogo de R. Cansinos Assens", "Las mil y una noche T III", "Aguilar", "1955", "Piel", "Fsillon"));
        ...
        b.add(new Book("Doctor J. C. Mardruz", "El libro de las mil y una noche T. I, II y III", "Cía Gral. Edic.", "1957", "4ª ed.", "Fsillon"));
        ...
        b.add(new Book("Louis de Raymaeker", "Introducción a la folosofía Nº 4", "Gredos", "1969", "2ª ed. Ampl.", "Fsillon"));
        ...
        b.add(new Book("José Vives, S. I.", "Génesis y evolución de la ética platónica Nº 64", "Gredos", "1970", "", "Fsillon"));
        ...
        b.add(new Book("Guillermo Fraile, O. P.", "Historia de la filosofía I Grecia y Roma nº 160", "B. A. C.", "1965", "2ª ed.", "Fsillon"));
        b.add(new Book("Alfonso López Quintás", "Pensadores cristianos contemporáneos I Nº 274", "B. A. C.", "1968", "", "Fsillon"));
        ...
        b.add(new Book("José Ortega y Gasset", "Obras completas T. I y II", "R. Occidente", "1966", "7ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. III y IV", "R. Occidente", "1966", "6ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. V", "R. Occidente", "1970", "7ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. VI", "R. Occidente", "1964", "6ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. VII", "R. Occidente", "1969", "3ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. VIII", "R. Occidente", "1970", "3ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. IX", "R. Occidente", "1971", "3ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("José Ortega y Gasset", "Obras completas T. X y XI", "R. Occidente", "1969", "C. Dor.", "Fsillon"));
        ...
        b.add(new Book("Charlotte Bühler", "El curso de la vida humana como problema psicológico", "Espasa Calpe", "1943", "", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Meditaciones y ens. espirituales T. VII", "Scelicer", "1967", "C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Autobiografía y recuerdos pers. T.VIII", "Scelicer", "1966", "C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Discursos y artículos T. IX", "Scelicer", "1971", "C. Dorado", "Fsillon"));
        ...
        b.add(new Book("José Ferrater Mora", "Diccionario de Filosofía T. II", "Sudamericana", "1965", "5ª ed.", "Fsillon"));
        b.add(new Book("Georg Lukács", "El asalto a la razón", "F. C. E.", "1959", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. I El origen de la tragedia", "M. Aguilar", "1947", "", "Fsillon"));
        ...
        b.add(new Book("Gilles Deleuze y F. Guattari", "Mil mesetas (capitalismo y esquizofrenia)", "Pre-textos", "1988", "", "Fsillon"));
        b.add(new Book("Giuseppe Ricciotti", "Vida de Jesucristo", "Luis Miracle", "1979", "", "Fsillon"));
        b.add(new Book("Hans Urs Von Balthasar", "Gloria 1: La percepción y la gloria", "Encuentro", "1985", "", "Fsillon"));
        ...
        b.add(new Book("Hans Urs Von Balthasar", "Gloria 4: Metafísica. Edad antigua", "Encuentro", "1986", "", "Fsillon"));
        b.add(new Book("Hans Urs Von Balthasar", "Gloria 5: Matafísica. Edad moderna", "Encuentro", "1988", "", "Fsillon"));
        ...
        b.add(new Book("H. Vorgrimler y R. V. Gucht", "La teología en el s. XX/I El entorno cultural", "BAC", "1973", "", "Fsillon"));
        b.add(new Book("H. Vorgrimler y R. V. Gucht", "La teología en el s. XX/II y III Tª gral. y discus. Teológicas", "BAC", "1973", "", "Fsillon"));
        ...
        b.add(new Book("Arnold J. Toynbee", "Estudio de la Historia T. IV  Parte 1ª y 2ª", "Emecé", "1955", "", "Fsillon"));
        b.add(new Book("Arnold J. Toynbee", "Estudio de la Historia T. VI Parte 1ª y 2ª", "Emecé", "1959", "", "Fsillon"));
        ...
        b.add(new Book("Prólogo de R. Cansinos Assens", "Las mil y una noche T II", "Aguilar", "1955", "Piel", "Fsillon"));
        ...
        b.add(new Book("Benedetto Croce", "La historia como azaña de la libertad nº 18", "F. C. E.", "1960", "2ª ed.", "Fsillon"));
        ...
        b.add(new Book("Manuel Gonzalo Casas", "Introducción a la filosofía Nº 27", "Gredos", "1967", "3ª ed.", "Fsillon"));
        ...
        b.add(new Book("Ramón del Valle Inclán", "Obras completas T. I y II Ej. Nº 870", "Plenitud", "1954", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,3ª ed. C. Dor.", "Fsillon"));
        b.add(new Book("Mario Méndez Bejarano", "Hª de la Filosofía en España hasta el siglo XX", "Renacimiento", "", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("André Gide", "Obras escogidas", "Aguilar", "1967", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2ª ed Num. 1811", "Fsillon"));
        b.add(new Book("Albert Camus", "Narraciones y teatro", "Aguilar", "1979", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,7ª ed.", "Fsillon"));
        b.add(new Book("Albert Camus", "Obras completas T II", "Aguilar", "1968", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,3ª ed", "Fsillon"));
        b.add(new Book("Aristóteles", "Obras", "Aguilar", "1982", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,1ª ed.", "Fsillon"));
        b.add(new Book("Stefan Zweig", "Obras completas Biografías ** III", "Juventud", "1953", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Georg Lukács", "Estética 1", "Grijalbo", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Bertrand Russell", "Historia de la filosofía T I y II  (2 ejemplares)", "Aguilar", "1973", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,Piel", "Fsillon"));
        b.add(new Book("Henry Miller", "Big Sur y las naranjas de Hieronymus Bosch", "Losada", "1960", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Alfred North Whitehead", "El concepto de la naturaleza Nº 56", "Gredos", "1968", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,Intonso", "Fsillon"));
        b.add(new Book("Roger Verneaux", "Lecciones sobre el ateísmo moderno Nº 66", "Gredos", "1971", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2 ejemplares", "Fsillon"));
        b.add(new Book("Wilhelm Windelband", "Hª de la Filosofía La Fª de los griegos y helenística  I y II", "Robredo", "1948", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2ª ed.", "Fsillon"));
        b.add(new Book("Ch. Guignebert", "El cristianismo antiguo nº 114", "F. C. E.", "1656", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2 ejemplares", "Fsillon"));
        b.add(new Book("Wilhelm Windelband", "Hª de la filosofía La Fª  de la E. M. y del Renacimiento III y IV", "Robredo", "1946", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2ª ed.", "Fsillon"));
        b.add(new Book("Wilhelm Windelband", "Hª de la Fª  El idealismo alemán y la Fª del iluminismo V y VI", "Robredo", "1946", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2ª ed.", "Fsillon"));
        b.add(new Book("Ch. Guignebert", "El cristianismo medieval y moderno nº 126", "F. C. E.", "1957", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,2 ejemplares", "Fsillon"));
        b.add(new Book("Burckhardt", "Historia de la cultura griega I y II", "O. Maestras", "1953", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Osvald Spengler", "La decadencia de Occidente V. III y IV", "Espasa Calpe", "1949", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Pitirim A. Sorokin", "Dinámica social y cultural T- I y II", "Inst. Est. Políticos", "1952", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Platón", "Obras completas T. I, II, III y IV", "Anaconda", "1946", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Arnold J. Toynbee", "Estudio de la Historia T. II", "Emecé", "1953", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Arnold J. Toynbee", "Estudio de la Historia T. V", "Emecé", "1957", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Arnold J. Toynbee", "Estudio de la Historia T. X", "Emecé", "1962", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T II", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T III", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T IV", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T V", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T VI", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T VII", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T VIII", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T IX", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XV", "Lorenzana", "1964", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XVII", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XIX", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XXI", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XXIV", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XXIX", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Honorato de Balzac", "La comedia humana   T XXX", "Lorenzana", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. II Novelas", "Afr. Aguado", "1951", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. III Ensayos", "Afr. Aguado", "1950", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. IV Ensayos", "Afr. Aguado", "1950", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. V De esto y aquello I", "Afr. Aguado", "1951", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. VI La raza y la lengua", "Afr. Aguado", "1958", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. VII Prólogos, conf., discursos", "Afr. Aguado", "1959", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. VIII Letras de América y ...", "Afr. Aguado", "1961", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. IX Novela II y monodiálogos", "Afr. Aguado", "1961", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. XI Medit. y otros escritos", "Afr. Aguado", "1962", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. XII Teatro", "Afr. Aguado", "1962", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. XIII Poesía I", "Afr. Aguado", "1962", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. XV Poesía III", "Afr. Aguado", "1963", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras Completas Paisajes y ensayos T. I", "Scelicer", "1966", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Novelas T. II", "Scelicer", "1967", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Nuevos ensayos T. III", "Scelicer", "1968", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas La raza y la lengua T. IV", "Scelicer", "1968", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Teatro completo T. V", "Scelicer", "1968", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas Poesía T. VI", "Scelicer", "1969", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO,C. Dorado", "Fsillon"));
        b.add(new Book("Bartolomé Carranza", "Comentarios sobre el catecismo cristiano I y II", "BAC", "1972", "MAESTROS DEL PENSAMIENTO CONTEMPORÁNEO", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. I Paisaje", "Afr. Aguado", "1951", "BREVIARIOS DEL F. C. E.zq,C. Dorado", "Fsillon"));
        b.add(new Book("JohannesB. Bauer", "Diccionaro de Teología bíblica", "Herder", "1972", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("X. Léon-Dufour", "Vocabulario de teología bíblica", "Herder", "1978", "BREVIARIOS DEL F. C. E.zq;10ª ed.", "Fsillon"));
        b.add(new Book("Georg Lukács", "Estética 3 y 4", "Grijalbo", "1967", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Obras completas T. VI", "Grijalbo", "1968", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Obras completas T. XI", "Grijalbo", "1970", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Obras completas T. XII", "Grijalbo", "1969", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Obras completas T. XIX", "Grijalbo", "1969", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Aportaciones a la historia de la estética", "Grijalbo", "1966", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Prolegómenos a una estética marxista", "Grijalbo", "1965", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "El joven Hegel", "Grijalbo", "1963", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Ensayos sobre el realismo", "Siglo veinte", "1965", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Significación actual del realismo crítico", "ERA", "1963", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("TOMOS I a XII", "DICCIONARIO ENCICLOPÉDICO SALVAT", "Salvat", "1955", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Estética 2", "Grijalbo", "1966", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Georg Lukács", "Obras completas T. I", "Grijalbo", "1975", "BREVIARIOS DEL F. C. E.zq", "Fsillon"));
        b.add(new Book("Miguel de Unamuno", "Obras completas  T. XVI Ensayos espir.  y otros esc.", "Afr. Aguado", "1964", "C. Dorado", "Fsillon"));
        b.add(new Book("José Ferrater Mora", "Diccionario de Filosofía", "Sudamericana", "1951", "3ª ed.", "Fsillon"));
        b.add(new Book("José Ferrater Mora", "Diccionario de Filosofía T. I", "Sudamericana", "1965", "5ª ed.", "Fsillon"));
        b.add(new Book("José Ferrater Mora", "Diccionario de Filosofía", "Atlante", "1944", "2ª ed.", "Fsillon"));
        b.add(new Book("Gÿorgy Lukács", "Diario 1910-1911 y otros inéditos de juventud", "Península", "1985", "", "Fsillon"));
        ...
        b.add(new Book("Anatole France", "Novelas completas y otros escritos  T I, II y III", "Aguilar", "1967", "", "Fsillon"));
        ...
        b.add(new Book("Emmanuel Kant", "Crítica de la razón pura y prolegómenos a ...", "El Ateneo", "1950", "", "Fsillon"));
        ...
        b.add(new Book("Angel González Alvarez", "Tratado de metafísica Ontología  Nº 30", "Gredos", "1961", "", "Fsillon"));
        ...
        b.add(new Book("K. H. Volkmann-Schluck", "Introducción al pensamiento filosófico Nº 50", "Gredos", "1967", "", "Fsillon"));
        b.add(new Book("Karl Jaspers", "Psicología de las concepciones del mundo Nº 51", "Gredos", "1967", "", "Fsillon"));
        ...
        b.add(new Book("Juan Zaragüeta", "Curso de Filosofía II Cosmología y antropología Nº 53", "Gredos", "1968", "", "Fsillon"));
        b.add(new Book("Juan Zaragüeta", "Curso de Filosofía III Ontología y ética Nº 53", "Gredos", "1968", "", "Fsillon"));
        ...
        b.add(new Book("René Scherer", "La fenomenología de las \"I.L.\" de Husserl Nº 59", "Gredos", "1969", "", "Fsillon"));
        b.add(new Book("Teodoro de Andrés S. I.", "El nominalismo de G. de Ochkham Nº 60", "Gredos", "1969", "", "Fsillon"));
        ...
        b.add(new Book("Gerardo Remolina Vargas, S.I.", "K. Jaspers en el diálogo de la fe Nº 76", "Gredos", "1972", "", "Fsillon"));
        b.add(new Book("Karl Jaspers", "Conferencias y ensayos sobre Hª de la Fil. Nº 77", "Gredos", "1972", "", "Fsillon"));
        b.add(new Book("Miguel F. Sciacca", "El oscurecimiento de la inteligencia Nº 79", "Gredos", "1973", "", "Fsillon"));
        b.add(new Book("G. M. A. Grube", "El pensamiento de Platón Nº 80", "Gredos", "1973", "", "Fsillon"));
        b.add(new Book("Guillermo A. Nicolás", "El hombre un ser en vías de realización Nº 81", "Gredos", "1974", "", "Fsillon"));
        b.add(new Book("Fernando Goñi Arregui", "La cara oculta del mundo físico Nº 82", "Gredos", "1974", "", "Fsillon"));
        ...
        b.add(new Book("Eutimio Martino", "Aristóteles. El alma y la comparación Nº 85", "Gredos", "1975", "", "Fsillon"));
        b.add(new Book("Sergio Rábade Romeo", "Hume y el fenomenismo moderno Nº 86", "Gredos", "1975", "", "Fsillon"));
        b.add(new Book("C. Díaz y M. Maceiras", "Introducción al personalismo actual Nº 87", "Gredos", "1975", "", "Fsillon"));
        b.add(new Book("Alberto Wagner de Reyna", "Analogía y evocación Nº 88", "Gredos", "1976", "", "Fsillon"));
        b.add(new Book("Alfonso López Quintás", "Cinco grandes tareas de la Fª actual Nº 89", "Gredos", "1977", "", "Fsillon"));
        b.add(new Book("Fernando Martín Balzas", "La teología de S. del Río y del K. Español Nº 90", "Gredos", "1977", "", "Fsillon"));
        b.add(new Book("Ernesto Grassi", "Humanismo y marxismo Nº 91", "Gredos", "1977", "", "Fsillon"));
        b.add(new Book("Guillermo Fraile, O. P.", "Historia de la filosofía III Humanismo Nº 259", "B. A. C.", "1966", "", "Fsillon"));
        b.add(new Book("Guillermo Fraile, O. P.", "Historia de la folisofía española Nº 327", "B. A. C.", "1971", "", "Fsillon"));
        b.add(new Book("Guillermo Fraile, O. P.", "Historia de la filosofía española Nº 330", "B. A. C.", "1972", "", "Fsillon"));
        b.add(new Book("Teófilo Urdanoz, O. P.", "Historia de la Filosofía IV Nº 371", "B. A. C.", "1975", "", "Fsillon"));
        b.add(new Book("Teófilo Urdanoz, O. P.", "Historia de la Filosofía V Nº 375", "B. A. C.", "1975", "", "Fsillon"));
        b.add(new Book("Alfonso López Quintás", "Filosofía española comtemporánea Nº 298", "B. A. C.", "1970", "", "Fsillon"));
        ...
        b.add(new Book("Marcelino Menéndez y  Pelayo", "Historia de los heterodoxos españoles I", "B. A. C.", "1978", "", "Fsillon"));
        b.add(new Book("Marcelino Menéndez y  Pelayo", "Historia de los heterodoxos españoles II", "B. A. C.", "1978", "", "Fsillon"));
        ...
        b.add(new Book("Condesa D'Aulnoy", "Viaje por España y cuentos feericos  I y II", "O. Maestras", "1962", "", "Fsillon"));
        ...
        b.add(new Book("Federico Nietzsche O. Compl.", "T. II Consideraciones intespestivas", "M. Aguilar", "1949", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. III Humano, demasiado humano 1", "M. Aguilar", "1948", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. IV Humano, demasiado humano 2", "M. Aguilar", "1948", "", "Fsillon"));
        ...
        b.add(new Book("Federico Nietzsche O. Compl.", "T. VII Así habló Zaratustra", "M. Aguilar", "1947", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. VIII Más allá del bien y del mal", "M. Aguilar", "1947", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. IX La voluntad de dominio", "M. Aguilar", "1947", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. X El ocaso de los ídolos", "M. Aguilar", "1949", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. XI Ecce homo", "M. Aguilar", "1950", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. XII Tratados filosóficos", "M. Aguilar", "1950", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. XIII Filosofía general", "M. Aguilar", "1950", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. XIV La cultura de los griegos", "M. Aguilar", "1955", "", "Fsillon"));
        b.add(new Book("Federico Nietzsche O. Compl.", "T. XV Correspondencia", "M. Aguilar", "1951", "", "Fsillon"));
        b.add(new Book("Arturo Schopenhauer", "El mundo como voluntad y representación", "M. Aguilar", "1927", "", "Fsillon"));
        ...
        b.add(new Book("Edward Schillebeeckx", "Jesús, la historia de un viviente", "Cristiandad", "1981", "", "Fsillon"));
        ...
        b.add(new Book("Varios Autores", "El pensamiento filosófico I y II nº 97 y 98", "F. C. E.", "1954", "", "Fsillon"));
        ...
        b.add(new Book("Claude Lévi-Strauss", "El pensamiento salvaje nº 173", "F. C. E.", "1970", "1ª reimp.", "Fsillon"));
        ...
        b.add(new Book("Raul N. Ondarza", "Introducción a la biología moderna nº 178", "F. C. E.", "1964", "", "Fsillon"));
        ...
        b.add(new Book("Michel Foucault", "Hª de la locura en la época clásica nº 191", "F. C. E.", "1967", "", "Fsillon"));
        b.add(new Book("Michel Foucault", "Hª de la locura en la época clásica nº 191 I y II", "F. C. E.", "1976", "2ª ed.", "Fsillon"));
        b.add(new Book("V. Gordon Childe", "Los orígenes de la civilización nº 92", "F. C. E.", "1988", "19ª reimp.", "Fsillon"));
        ...
        b.add(new Book("A. Phillips Griffiths", "Conocimiento y creencia nº 245", "F. C. E.", "1974", "Rústica", "Fsillon"));
        b.add(new Book("C. W. K. Mundle", "Una crítica de la filosofía lingüística nº 249", "F. C. E.", "1975", "", "Fsillon"));
        b.add(new Book("Félix E. Opepenhein", "Etica y filosofía política nº 252", "F. C. E.", "1976", "", "Fsillon"));
        b.add(new Book("W. G. Runciman", "Crítica de la Fª de las c. s. de Max Weber nº 255", "F. C. E.", "1976", "", "Fsillon"));
        b.add(new Book("R. Frondizi", "Introducción a los prob. fund. del hombre nº 260", "F. C. E.", "1977", "Rústica", "Fsillon"));
        ...
        b.add(new Book("Douglas R. Price-Williams", "Por los senderos de la psicología  intercultural nº 281", "F. C. E.", "1980", "", "Fsillon"));
        b.add(new Book("Isaiah Berlin", "Pensadores rusos nº 287", "F. C. E.", "1979", "", "Fsillon"));
        b.add(new Book("R. J. Zwi Werblowsky", "Más allá de la tradición y la modernidad nº 295", "F. C. E.", "1981", "", "Fsillon"));
        b.add(new Book("I. C. Tipton (ed.)", "Locke y el entendimiento humano nº 298", "F. C. E.", "1981", "", "Fsillon"));
        ...
        b.add(new Book("Elías Canetti", "La conciencia de las palabras n 218", "F. C. E.", "1982", "1ª reimp.", "Fsillon"));
        b.add(new Book("Sidney Hook", "Lenguaje y filosofía nº221", "F. C. E.", "1982", "", "Fsillon"));
        b.add(new Book("Andrew Arato/Paul Breines", "El joven Lukács y los orígenes del marxismo occ. nº336", "F. C. E.", "1986", "", "Fsillon"));
        b.add(new Book("Roger Caillois", "Los juegos y los hombres nº 344", "F. C. E.", "1980", "", "Fsillon"));
        b.add(new Book("Kenneth Thompson", "Augusto Comte Los orígenes de la sociología nº 378", "F. C. E.", "1988", "", "Fsillon"));
        ...
        b.add(new Book("Suetonio y Petronio", "Suetonio: Los doce Césares Petronio: El satiricón", "El Ateneo", "1959", "2ª ed.", "Fsillon"));
        ...
        b.add(new Book("Guillermo Fraile, O. P.", "Historia de la filosofía II Judaísmo Nº 190", "B. A. C.", "1966", "2ª ed.", "Fsillon"));
    }
    ...
    private static void fillFiloextranjera() {
        ...
        b.add(new Book("Dirección. C. D. Kernig", "Marxismo y democracia Filosofía 1, 2, 3, 4 y 5", "Rioduero", "1975", "", "Filoextranjera"));
        b.add(new Book("Jorge Plejanov", "El papel del individuo en la historia", "Intermundo", "1959", "", "Filoextranjera"));
        b.add(new Book("Francois Umbral-Xavier Delcourt", "Contra la nueva filosofía", "Premia Edra.", "1978", "", "Filoextranjera"));
        ...
        b.add(new Book("Rodolfo Puiggros", "Los orígenes de la filosofía", "Jorge Alvarez", "1966", "", "Filoextranjera"));
        b.add(new Book("Otto Friedrich Bollnow", "Filosofía de la esperanza", "Fabril", "1962", "", "Filoextranjera"));
        b.add(new Book("Adam Schatt", "Filosofía del hombre Marx o Sartre", "Grijalbo, S.A.", "1965", "", "Filoextranjera"));
        ...
        b.add(new Book("Aldo Pellegrini", "Para contribuir a la confusión general", "Nueva Visión", "1965", "", "Filoextranjera"));
        ...
        b.add(new Book("Benjamín Farrington", "Mano y cerebro en la antigua Grecia", "Ayuso", "1974", "", "Filoextranjera"));
        b.add(new Book("Petros Kuropulos", "El tiempo en el hombre", "Ayuso", "1970", "", "Filoextranjera"));
        b.add(new Book("Louis Ferdinand Celine", "Casse Pipe Conversaciones con el Profesor Y", "Guadarrama", "1976", "", "Filoextranjera"));
        b.add(new Book("Geneviere Rodis-Lewis", "Descartes y el racionalismo", "Oikos-tau, S.A.", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("Vito Fumagalli", "Cuando el cielo se oscurece La vida en la E. Media", "Nerea", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("Oswald Ducrot y otros", "¿Qué es el estructuralismo?", "Losada, S.A.", "1971", "", "Filoextranjera"));
        b.add(new Book("Robert Scholes", "Introducción al estructuralismo en la literatura", "Gredos", "1981", "", "Filoextranjera"));
        b.add(new Book("L. Seve y otros", "Dialéctica y estructuralismo", "Orbelius", "1969", "", "Filoextranjera"));
        b.add(new Book("Louis Millet Madeleine V. d'Ainvelle", "El estructuralismo como método", "Edicusa", "1972", "", "Filoextranjera"));
        b.add(new Book("François Wahl", "¿Qué es el estructuralismo? Filosofía", "Losada", "1975", "", "Filoextranjera"));
        b.add(new Book("Maurice Corvez", "Los estructuralistas: Foucault, Levi-Straus, Lacan...", "Amorrortu", "1972", "", "Filoextranjera"));
        b.add(new Book("Pierre Daix, Piaget y otros", "Claves del estructuralismo", "Calden", "1969", "", "Filoextranjera"));
        b.add(new Book("Jean B. Fages", "Para comprender el estructuralismo", "Galerna", "1969", "", "Filoextranjera"));
        b.add(new Book("C. Levi-Straus y otros", "Aproximación al estructuralismo", "Galerna", "1967", "", "Filoextranjera"));
        b.add(new Book("Oscar Masotta", "Conciencia y estructura", "Jorge Alvarez", "1968", "", "Filoextranjera"));
        b.add(new Book("Romano Luperini", "El estructuralismo y la crítica marxista", "Centro Editor", "1968", "", "Filoextranjera"));
        b.add(new Book("Dan Sperber", "El estructuralismo en antropología", "Losada, S.A.", "1975", "", "Filoextranjera"));
        ...
        b.add(new Book("Jean Pieget", "Sabiduría e ilusiones de la filosofía", "Península", "1970", "", "Filoextranjera"));
        b.add(new Book("Jeanne Parain-Vial", "Análisis estructurales e ideologías estructuralistas", "Amorrortu", "1972", "", "Filoextranjera"));
        ...
        b.add(new Book("Jean Lacroix", "Marxismo Existencialismo Personalismo", "Fontanella", "1962", "", "Filoextranjera"));
        ...
        b.add(new Book("J. Huxley y otros", "El humanismo y el futuro del hombre", "Hormé, S.A.", "1969", "", "Filoextranjera"));
        b.add(new Book("Robert Wallis", "El tiempo, cuarta dimensión de la mente", "El Ateneo", "1976", "", "Filoextranjera"));
        ...
        b.add(new Book("Franz Borkenau", "Arnold Toynbee y la nueva decadencia", "Siglo veinte", "1957", "", "Filoextranjera"));
        ...
        b.add(new Book("Ludwig Feuerbach", "Tesis provisionales para la reforma de la filosofía", "Labor, S.A.", "1976", "", "Filoextranjera"));
        b.add(new Book("Michel Butor y otros", "Aproximación al pensamiento de Fourier", "Castellote", "1973", "", "Filoextranjera"));
        ...
        b.add(new Book("H. S. Blackham", "Seis pensadores existencialistas; Sartre, Marcel...", "E. de Occidente", "1964", "", "Filoextranjera"));
        ...
        b.add(new Book("W. V. Quine", "La relatividad ontológica y otros ensayos", "Tecnos", "1974", "", "Filoextranjera"));
        b.add(new Book("Edgar Morin", "El método III El conocimiento del conocimiento", "Cátedra", "1988", "", "Filoextranjera"));
        b.add(new Book("Edward Evans-Pritchard", "Historia del pensamiento antropológico", "Cátedra", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("C. K. Ogden y I. A. Richards", "El significado del significado", "Paidos", "1984", "", "Filoextranjera"));
        ...
        b.add(new Book("Henri Bergson", "Introduc. a la metafísica y a la intuición filosófica", "Leviatán", "1956", "", "Filoextranjera"));
        ...
        b.add(new Book("Roger Verneaux", "Crítica de la \"Critica de la razón pura\"", "Rialp", "1978", "", "Filoextranjera"));
        b.add(new Book("Robert Spaemann", "Lo natural y lo racional", "Rialp", "1989", "", "Filoextranjera"));
        b.add(new Book("I. M. Bochenski", "Los métodos actuales del pensamiento", "Rialp", "1985", "15ª ed.", "Filoextranjera"));
        b.add(new Book("Bronislaw Malinowski", "Una teoría científica de la cultura", "Edhasa", "1970", "", "Filoextranjera"));
        ...
        b.add(new Book("Pietro Scarduelli", "Introducción a la antropología cultural", "Villalar", "1977", "", "Filoextranjera"));
        ...
        b.add(new Book("François Chatelet (Director)", "Historia de las ideologías I y II", "Zero Zyx", "1978", "", "Filoextranjera"));
        b.add(new Book("Jorge Uscatescu", "Hombres y realidades de nuestro tiempo", "Rialp", "1961", "", "Filoextranjera"));
        ...
        b.add(new Book("Eduard Spranger", "Reflexiones sobre el desarrollo de la existencia", "Fabril, S.A.", "1964", "", "Filoextranjera"));
        b.add(new Book("Angel J. Cappelletti", "Los fragmentos de Heráclito", "Tiempo Nuevo", "1972", "", "Filoextranjera"));
        ...
        b.add(new Book("George Lakoff y Mark Johnson", "Metáforas de la vida cotidiana", "Cátedra", "1986", "", "Filoextranjera"));
        b.add(new Book("Jonathan Barnes", "Aristóteles", "Cátedra", "1987", "", "Filoextranjera"));
        b.add(new Book("Julius Weinberg", "Breve historia de la filosofía medieval", "Cátedra", "1987", "", "Filoextranjera"));
        b.add(new Book("David Ross", "Teoría de las ideas de Platón", "Cátedra", "1986", "", "Filoextranjera"));
        b.add(new Book("Alexander Woodcock y Monte Davis", "Teoría de las catástrofes", "Cátedra", "1986", "", "Filoextranjera"));
        ...
        b.add(new Book("Varios autores", "La lechuza de Minerva ¿Qué es filosofia?", "Cátedra", "1979", "", "Filoextranjera"));
        b.add(new Book("Richard Rorty", "La filosofía y el espejo de la naturaleza", "Cátedra", "1983", "", "Filoextranjera"));
        b.add(new Book("Igor A. Caruso", "Narcisismo y socialización", "Siglo XXI", "1979", "", "Filoextranjera"));
        b.add(new Book("Marta Harnecker", "Los conceptos fund. del materialismo histórico", "Siglo XXI", "1973", "20ª ed.", "Filoextranjera"));
        ...
        b.add(new Book("W. H. Walsh", "Introducción a la filosofía de la historia", "Siglo XXI", "1968", "", "Filoextranjera"));
        b.add(new Book("Michel Adam", "La calumnia, relación humana", "Siglo XXI", "1968", "", "Filoextranjera"));
        b.add(new Book("Thomas Moro Simpson Compilador", "Semántica filosófica: Problemas y discursos", "Siglo XXI", "1973", "", "Filoextranjera"));
        b.add(new Book("Marshall Berman", "Todo lo sólido se desvanece en el aire", "Siglo XXI", "1988", "", "Filoextranjera"));
        b.add(new Book("Nicolai I. Bujarin", "Teoría del materialismo histórico", "Siglo XXI", "1974", "2ª ed.", "Filoextranjera"));
        b.add(new Book("Antonio Gramsci", "Antología Notas de Manuel Sacristán", "Siglo XXI", "1974", "2ª ed.", "Filoextranjera"));
        ...
        b.add(new Book("P. Teilhard de Chardin", "Nuevas cartas de viaje (1939-1955)", "Taurus", "1960", "", "Filoextranjera"));
        ...
        b.add(new Book("Gregoty Bateson y Mari C. Bateson", "El temor de los ángeles", "Gedisa", "1989", "", "Filoextranjera"));
        ...
        b.add(new Book("Karl Jaspers", "La práctica médica en la era tecnológica", "Gedisa", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("Ernst Cassirer", "Esencia y efecto del concepto del símbolo", "F. C. E.", "1975", "", "Filoextranjera"));
        b.add(new Book("H. H. Price", "Pensamiento y experiencia", "F. C. E.", "1975", "", "Filoextranjera"));
        b.add(new Book("Paul Kurtz", "Filosofía norteamericana en el siglo veinte", "F. C. E.", "1972", "", "Filoextranjera"));
        b.add(new Book("Soren Kierkegaard", "In vino veritas La repetición", "Guadarrama", "1975", "", "Filoextranjera"));
        b.add(new Book("Kierkegaard", "Elogio de Abraham (Páginas líricas)", "Athenas", "1959", "Intonso", "Filoextranjera"));
        ...
        b.add(new Book("Drew A. Hiland", "Los orígenes de la Fª en el mito y los presocráticos", "El Ateneo", "1975", "", "Filoextranjera"));
        b.add(new Book("E. R. Learch", "Sistemas políticos de la Alta Birmania", "Anagrama", "1977", "", "Filoextranjera"));
        b.add(new Book("E. R. Learch", "Replanteamiento de la antropología", "Seix Barral", "1971", "", "Filoextranjera"));
        b.add(new Book("Marcel Mauss", "Sociología y antropología", "Tecnos", "1971", "", "Filoextranjera"));
        b.add(new Book("Marvin Harris", "El desarrollo de la teoría antropológica", "Siglo XXI", "1978", "", "Filoextranjera"));
        ...
        b.add(new Book("Rodolfo Mondolfo", "Figuras e ideas de la filosofía del renacimiento", "Icaria", "1980", "", "Filoextranjera"));
        ...
        b.add(new Book("Victor Massuh", "Nietzsche y el fin de la religión", "Sudamericana", "1969", "", "Filoextranjera"));
        b.add(new Book("Paul Valadier", "Nietzsche y la crítica del cristianismo", "Cristiandad", "1982", "", "Filoextranjera"));
        b.add(new Book("Jules Chaix-Ruy", "Síntesis del pensamiento de Nietzsche", "Nova Terra", "1974", "", "Filoextranjera"));
        b.add(new Book("Eugen Biser", "Nietzsche y la destrucción de la conciencia cristiana", "Sígueme", "1974", "", "Filoextranjera"));
        ...
        b.add(new Book("Rafael Gutiérrez Girardot", "Nietzsche y la filología clásica", "Eudeba", "1966", "", "Filoextranjera"));
        b.add(new Book("Otto Pöggeler", "Filosofía y política de Heidegger", "Alfa", "1984", "", "Filoextranjera"));
        b.add(new Book("Otto Pöggeler", "El camino del pensar de Martín Heidegger", "Alianza", "1986", "", "Filoextranjera"));
        ...
        b.add(new Book("Henst Bloch", "Sujeto-objeto (El pensamiento de Hegel)", "F. C. E.", "1982", "", "Filoextranjera"));
        ...
        b.add(new Book("Jacques D'Hont Director", "Hegel y el pensamiento moderno", "Siglo XXI", "1973", "", "Filoextranjera"));
        b.add(new Book("Ludwig Wittgenstein", "Los cuadernos azul y marrón", "Tecnos", "1968", "", "Filoextranjera"));
        b.add(new Book("Alejandro Tomasini Bassols", "El pensamiento del último Wittgenstein", "Trillas", "1988", "", "Filoextranjera"));
        b.add(new Book("Peter Winch y colaboradores", "Estudios sobre la filosofía de Wittgenstein", "Eudeba", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("G. E. M. Auscombe", "Introducción al \"Tractatus\" de Wittgenstein", "El Ateneo", "1977", "", "Filoextranjera"));
        ...
        b.add(new Book("Friedrich Dessaner", "Discusión sobre la técnica (lingüística)", "Rialp", "1964", "", "Filoextranjera"));
        b.add(new Book("Antoinette Virieux-Reymond", "La lógica formal", "El Ateneo", "1976", "", "Filoextranjera"));
        b.add(new Book("Benedictus de Spinoza", "Tratado breve de Dios, del hombre y...", "C. Lectores", "1995", "", "Filoextranjera"));
        b.add(new Book("Platón", "La república", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("René Descartes", "Discurso del método. Correspondencia", "C. Lectores", "1996", "", "Filoextranjera"));
        ...
        b.add(new Book("G. W. F. Hegel", "Lecciones sobre la filosofía de la historia", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Ludwing Feuerbach", "La esencia del cristianismo", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Wilhelm von Humboldt", "Sobre la diversidad de la estructura del lenguaje", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Jean-Jacques Rousseau", "Discursos. El contrato social", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Juan Huarte de San juan", "Examen de ingenios para las ciencias", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Diógenes Laercio", "Sexto empírico. Esbozos pirrónicos", "C. Lectores", "1996", "", "Filoextranjera"));
        b.add(new Book("Robert Stewart", "Ideas que transformaron el mundo", "C. Lectores", "1997", "", "Filoextranjera"));
        ...
        b.add(new Book("E. M. Cioran", "Ensayo sobre el pensamiento reaccionario y otros textos", "Montesinos", "1985", "", "Filoextranjera"));
        b.add(new Book("E. M. Cioran", "Silogismos de  la amargura", "Monte Avila", "1986", "", "Filoextranjera"));
        b.add(new Book("E. M. Cioran", "La caida del tiempo (2 ejemplares)", "Monte Avila", "1977", "2 ejemp.", "Filoextranjera"));
        b.add(new Book("Margaret Mead", "La antropología y el mundo contemporáneo", "Siglo XX", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("B. I. Skinner", "Más allá de la libertad y la dignidad", "Fontanella", "1977", "", "Filoextranjera"));
        ...
        b.add(new Book("Michel Federico Sciacca", "En espíritu y en verdad", "Excelicer, S.A.", "1955", "", "Filoextranjera"));
        b.add(new Book("Carlos Marx Federico Engels", "Manifiesto comunista y otros escritos", "Grijalbo", "1975", "", "Filoextranjera"));
        b.add(new Book("Marx Engels", "El libro rojo y negro", "Jucar", "1977", "", "Filoextranjera"));
        b.add(new Book("Federico Engels", "El origen de la familia, la propiedad priv. y  el estado", "Ayuso", "1972", "", "Filoextranjera"));
        b.add(new Book("Victor G. Afanasiev", "Fundamentos de filosofía marxista", "E. Mex. Unidos", "1978", "", "Filoextranjera"));
        ...
        b.add(new Book("W. V. Quine", "La relatividad ontológica y otros ensayos", "Tecnos", "1986", "1ª reimp.", "Filoextranjera"));
        ...
        b.add(new Book("Olof Gigon", "Problemas fundamentales de la filosofía antigua", "Fabril", "1962", "", "Filoextranjera"));
        ...
        b.add(new Book("Ralph Marcus Gerson D. Cohen", "II La época helenistica III La época Talmúdica", "Paidós", "1965", "", "Filoextranjera"));
        b.add(new Book("Abraham S. Halkin Cecil Roth", "IV La época judeo-islámica V La época europea", "Paidós", "1965", "", "Filoextranjera"));
        ...
        b.add(new Book("Thomas Mann Ed. A. Sánchez", "Schopenhauer, Nietzche, Freud", "Bruguera", "1984", "", "Filoextranjera"));
        b.add(new Book("Ludwig Landgrebe", "El camino de la fenomenología", "Sudamericana", "1968", "", "Filoextranjera"));
        ...
        b.add(new Book("Henry David Thoreau", "Walden seguido de Del deber de la des. Civil", "Del Cotal, S.A.", "1976", "", "Filoextranjera"));
        ...
        b.add(new Book("Gabriel Marcel", "Filosofía para un tiempo de crisis", "Guadarrama", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("Michel Vadée", "Bachelard o el nuevo idealismo epistemológico", "Pre-textos", "1977", "", "Filoextranjera"));
        b.add(new Book("Ernst Von Aster", "Introducción a la filosofía contemporánea", "Guadarrama", "1961", "", "Filoextranjera"));
        ...
        b.add(new Book("Pierre Jouguelet", "Humanismo y condición humana", "Eds. Humanismo", "1960", "", "Filoextranjera"));
        b.add(new Book("Max Weber", "La ética protestante y el espíritu del capitalismo", "Península", "1988", "8ª ed.", "Filoextranjera"));
        b.add(new Book("Jacques Heers", "Carnavales y fiestas de locos", "Península", "1988", "", "Filoextranjera"));
        b.add(new Book("Gershon Scholem", "Walter Benjamin Historia de una amistad", "Península", "1987", "", "Filoextranjera"));
        b.add(new Book("William James", "Las variedades de la experiencia religiosa", "Península", "1986", "", "Filoextranjera"));
        ...
        b.add(new Book("Georg Simmel", "Sobre la aventura Ensayos filosóficos", "Península", "1981", "", "Filoextranjera"));
        b.add(new Book("Ayatollah Jomeini", "Princ. políticos, filosóficos, sociales y religiosos", "Icaria", "1981", "", "Filoextranjera"));
        b.add(new Book("Schelling Ed. José L. Villacañas B.", "Antología", "Península", "1987", "", "Filoextranjera"));
        b.add(new Book("Antonio Gramsci", "Introducción a la filosofía de la praxis", "Península", "1970", "", "Filoextranjera"));
        ...
        b.add(new Book("George Uscatescu", "Aporías del estructuralismo", "Inst. Es. Polit.", "1971", "", "Filoextranjera"));
        b.add(new Book("Jean Pouillon y otros", "Problemas del estructuralismo", "Siglo XXI", "1967", "", "Filoextranjera"));
        b.add(new Book("Galvano Della Volpe/Lefebvre", "Ajuste de cuentas con el estructuralismo", "A. Corazón", "1969", "", "Filoextranjera"));
        b.add(new Book("F. Nietzche/Lou v. Salomé/ P. Rel", "Documentos de un encuentro", "Laertes", "1982", "2ª ed.", "Filoextranjera"));
        b.add(new Book("Jean Lacroix", "Los hombres ante el fracaso", "Herder", "1970", "", "Filoextranjera"));
        b.add(new Book("Rosa Krauze", "Introducción a la investigación filosófica", "U. Aut. México", "1978", "", "Filoextranjera"));
        ...
        b.add(new Book("Rosario Assunto", "Naturaleza y razón en la estética del setecientos", "Visor", "1989", "", "Filoextranjera"));
        b.add(new Book("Franz Rosenzweig", "El nuevo pensamiento", "Visor", "1989", "", "Filoextranjera"));
        b.add(new Book("Carl Friedrich Geyer", "Teoría crítica (Max. H./T. W. Adorno)", "Alfa", "1985", "", "Filoextranjera"));
        ...
        b.add(new Book("Gilles Deleuze", "Spinoza y el problema de la experiencia", "Muchnik", "1975", "", "Filoextranjera"));
        ...
        b.add(new Book("Luciano de Crescenzo", "Historia de la filosogía griega Los presocráticos", "Seix Barral", "1986", "", "Filoextranjera"));
        b.add(new Book("Luciano de Crescenzo", "Hª de la filosofía griega De Sócrates en adelante", "Seix Barral", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("Robert Wuthnow y otros", "Análisis cultural La obra de Berger...", "Paidos", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("Etienne Gilson", "De Aristóteles a Darwin (y vuelta)", "Eunsa", "1980", "2ª ed.", "Filoextranjera"));
        b.add(new Book("Etienne Gilson", "Elementos de filosofía cristiana", "Rialp", "1969", "", "Filoextranjera"));
        b.add(new Book("Lawrence Krader", "Los apuntes etnológicos de Karl Marx", "Siglo XXI", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("Paul Friedländer", "Platón verdad del ser y realidad de vida", "Tecnos", "1989", "", "Filoextranjera"));
        b.add(new Book("Varios autores", "Si los astros estuviesen habitados", "Fº de Cultura", "1964", "", "Filoextranjera"));
        b.add(new Book("Georges Bataille", "Documentos", "Monte Avila", "1969", "", "Filoextranjera"));
        b.add(new Book("Elemire Zolla", "Historia de la imaginación viciosa", "Monte Avila", "1968", "", "Filoextranjera"));
        ...
        b.add(new Book("Paul Oskar Kristeller", "El pensamiento renacentista y sus fuentes", "F. C. E.", "1982", "", "Filoextranjera"));
        b.add(new Book("Enrique D. Dussel", "Método para una filosofía de la liberación", "Sígueme", "1974", "", "Filoextranjera"));
        ...
        b.add(new Book("Feliciano Blázquez  Carmona", "La filosofía de Gabriel Marcel", "Encuentro", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("Claude Cuénot", "P. Teilhard de Chardín Etapas de su evolución", "Taurus", "1967", "", "Filoextranjera"));
        b.add(new Book("Dante Alighieri", "El convite. Monarquía. Disputa...", "C. Lectores", "1995", "", "Filoextranjera"));
        b.add(new Book("Richard H. Popkin", "La Hª del escepticismo desde Erasmo hasta Spinosa", "F. C. E.", "1983", "", "Filoextranjera"));
        b.add(new Book("Franklin L. Baumer", "El pensamiento europeo moderno. Continuidad y cambio...", "F. C. E.", "1985", "", "Filoextranjera"));
        ...
        b.add(new Book("Varios autores", "Ideas que hicieron nuestro tiempo", "Monte Avila", "1970", "", "Filoextranjera"));
        ...
        b.add(new Book("Bernard Henri-Levi", "La barbarie con rostro humano", "Monte Avila", "1978", "", "Filoextranjera"));
        ...
        b.add(new Book("P. Bürger y otros", "Estética de la recepción", "Arcolibros, S.A.", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("Ernst Cassirer", "Filosofía de las formas simbólicas I", "F. C. E.", "1971", "", "Filoextranjera"));
        b.add(new Book("Ernst Cassirer", "Filosofía de las formas simbólicas II", "F. C. E.", "1972", "", "Filoextranjera"));
        b.add(new Book("Ernst Cassirer", "Filosofía de las formas simbólicas III", "F. C. E.", "1976", "", "Filoextranjera"));
        ...
        b.add(new Book("C. R. Hallpike", "Los fundamentos del pensamiento primitivo", "F. C. E.", "1986", "", "Filoextranjera"));
        ...
        b.add(new Book("Javier Sádaba", "Lenguaje, magia y metafísica (El otro Wittgenstein)", "Pluma-Rota", "1984", "", "Filoextranjera"));
        ...
        b.add(new Book("Paul Goodman", "La nueva reforma Un nuevo manifiesto anarquista", "Kairos", "1972", "", "Filoextranjera"));
        b.add(new Book("Jean Bernhard y otros", "Divorcio e indisolubilidad del matrimonio", "Herder", "1963", "", "Filoextranjera"));
        ...
        b.add(new Book("Maestro Eckhart", "El fruto de la nada y otros escritos", "Siruela", "1998", "", "Filoextranjera"));
        b.add(new Book("Barón D'Holbach", "Sistema de la naturaleza", "Edra. Nacional", "1982", "", "Filoextranjera"));
        b.add(new Book("Ilse M. De Brugger", "Maestro Eckart Tratados y sermones", "Edhasa", "1983", "", "Filoextranjera"));
        b.add(new Book("E. Labrousse, R. Zazzo y otros", "Las estructuras y los hombres", "Ariel", "1969", "", "Filoextranjera"));
        ...
        b.add(new Book("G. W. Leibniz", "Nuevos ensayos sobre el entendimiento humano", "Edra. Nacional", "1983", "2ª ed.", "Filoextranjera"));
        ...
        b.add(new Book("Catherine Clément", "Vidas y leyendas de Jacques Lacan", "Anagrama", "1981", "", "Filoextranjera"));
        ...
        b.add(new Book("Paolo Caruso", "Conversaciones con Levi-Strauss, Foucault y Lacan", "Anagrama", "1969", "", "Filoextranjera"));
        b.add(new Book("Albert Forment", "José Martínez: La epopeya de Ruedo Ibérico", "Anagrama", "2000", "", "Filoextranjera"));
        ...
        b.add(new Book("Ino Rossi y Edward O'Higgins", "Teorías de la cultura y métodos antropológicos", "Anagrama", "1981", "", "Filoextranjera"));
        b.add(new Book("John J. Gumperz y Adrian Bennett", "Lenguaje y cultura", "Anagrama", "1981", "", "Filoextranjera"));
        ...
        b.add(new Book("Stanley Diamond y Bernard Belasco", "De la cultura primitiva a la cultura moderna", "Anagrama", "1982", "", "Filoextranjera"));
        ...
        b.add(new Book("Lawrence  Krader e Ino Rossi", "Antropología política", "Anagrama", "1982", "", "Filoextranjera"));
        b.add(new Book("Kenneth T. Gallagher", "La filosofía de Gabriel Marcel", "Razon y Fe", "1968", "", "Filoextranjera"));
        b.add(new Book("A. R. Radcliffe-Brown", "El método de la antropología social", "Anagrama", "1975", "", "Filoextranjera"));
        b.add(new Book("J. S. Kahn", "El concepto de cultura: textos fundamentales", "Anagrama", "1975", "", "Filoextranjera"));
        b.add(new Book("Adam Kuper", "Antropología y antropólogos La esc. Británica 1922-1972", "Anagrama", "1973", "", "Filoextranjera"));
        b.add(new Book("E. E. Evans-Pritchard", "Los Nuer", "Anagrama", "1977", "", "Filoextranjera"));
        b.add(new Book("M. Kay Martin y Bárbara Voorhies", "La mujer: un enfoque antropológico", "Anagrama", "1978", "", "Filoextranjera"));
        b.add(new Book("A. R. Radcliffe-Brown y Daryll Forde (Eds.)", "Sistemas africanos de parentesco y matrimonio", "Anagrama", "1982", "", "Filoextranjera"));
        b.add(new Book("Revista Anthropologica", "Anthropologica Nº 2 (1974)", "C. E. A. F.", "1972", "", "Filoextranjera"));
        b.add(new Book("Revista Anthropologica", "Anthropologica Nº 3 (1975)", "C. E. A. F.", "1972", "", "Filoextranjera"));
        b.add(new Book("Clifford Geertz", "El antropólogo como autor", "Paidos", "1989", "", "Filoextranjera"));
        b.add(new Book("Clifford Geertz", "La interpretación de las culturas", "Gedisa", "1988", "1ª reimp.", "Filoextranjera"));
        b.add(new Book("Ludovico Geymonat", "Hª del pensamiento filosófico y científico S. XX/I", "Ariel", "1984", "", "Filoextranjera"));
        b.add(new Book("Stanley M. Honer Thomas C. Hunt", "Invitación a la filosofía", "Diana, S.A.", "1969", "", "Filoextranjera"));
        b.add(new Book("Ernst Tugendhat", "Problemas de la ética", "Crítica", "1988", "", "Filoextranjera"));
        b.add(new Book("Ludovico Geymonat", "Hª del pensamiento filosófico y científico S. XX/II", "Ariel", "1985", "", "Filoextranjera"));
        b.add(new Book("Ludovico Geymonat", "Hª del pensamiento filosófico y científico S. XX/III", "Ariel", "1985", "", "Filoextranjera"));
        ...
        b.add(new Book("Kostas Axelos", "Argumentos para una investigación", "Fundamentos", "1973", "", "Filoextranjera"));
        b.add(new Book("Eli de Gortari", "Iniciación a la lógica", "Grijalbo, S.A.", "1972", "", "Filoextranjera"));
        b.add(new Book("P. L. Landsberg", "Reflexiones sobre Unamuno", "Cruz del Sur", "1963", "Cruz y Raya", "Filoextranjera"));
        ...
        b.add(new Book("Roland Barthes y otros", "Conversaciones sobre la nueva cultura", "Kairos", "1975", "", "Filoextranjera"));
        b.add(new Book("Alan Watts", "El futuro del éxtasis y otras meditaciones", "Kairos", "1974", "", "Filoextranjera"));
        b.add(new Book("Bernard Vincent", "Paul Goodman o la recuperación del presente", "Kairos", "1977", "", "Filoextranjera"));
        ...
        b.add(new Book("Jan Lukasiewicz", "Estudios de lógica y filosofía", "R. Occidente", "1975", "", "Filoextranjera"));
        ...
        b.add(new Book("Harold C. Raley", "Ortega y Gasset Filósofo de la unidad europea", "R. Occidente", "1977", "", "Filoextranjera"));
        ...
        b.add(new Book("Luigi de Marchi", "Wilhelm Reich Biografía de una idea", "Península", "1974", "", "Filoextranjera"));
        b.add(new Book("Bronislaw Malinowski", "Los argonautas del Pacífico occidental", "Península", "1973", "", "Filoextranjera"));
        ...
        b.add(new Book("Madeleine Barthelemy-Madaule", "La ideología del azar y la necesidad", "Barral", "1974", "", "Filoextranjera"));
        ...
        b.add(new Book("Michel Gourinat", "Introducción al pensamiento filosófico I, II y III", "Istmo", "1974", "", "Filoextranjera"));
        b.add(new Book("William Dunphy", "La nueva moral", "Sígueme", "1972", "", "Filoextranjera"));
        b.add(new Book("Emmanuel Mounier", "La esperanza de los desesperados: Malraux, Camus...", "Tiempo Nuevo", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("Jacques Derrida y otros", "Doce lecciones de filosofía", "J. Granica", "1983", "", "Filoextranjera"));
        b.add(new Book("Jacques Derrida", "Del espíritu Heidegger y la pregunta", "Pre-Textos", "1989", "", "Filoextranjera"));
        b.add(new Book("A. J. Ayer", "Ensayos filosóficos", "Ariel", "1979", "", "Filoextranjera"));
        b.add(new Book("Jacques Derrida", "Espolones Los estilos de Nietzche", "Pre-Textos", "1981", "", "Filoextranjera"));
        ...
        b.add(new Book("Roger Garaudy y otros Mayo 68", "Problemas en torno a un cambio de civilización", "El laberinto", "1988", "", "Filoextranjera"));
        b.add(new Book("Roger Garaudy y otros", "Lecciones de filosofía marxista", "Grijalbo, S.A.", "1966", "", "Filoextranjera"));
        ...
        b.add(new Book("Ignace Lepp", "Filosofía cristiana de la existencia", "Carlos Lohlé", "1963", "", "Filoextranjera"));
        b.add(new Book("Jacques Maritain", "Humanismo integral", "Carlos Lohlé", "1966", "", "Filoextranjera"));
        b.add(new Book("Louis Dumont", "Introduc. a  dos teorías de la antropología social", "Anagrama", "1975", "", "Filoextranjera"));
        ...
        b.add(new Book("A. J. Ayer y otros", "La filosofía y los problemas actuales", "Fundamentos", "1981", "", "Filoextranjera"));
        b.add(new Book("A. J. Ayer y otros", "Homenaje a Bertrand Russel", "Oikos-Tau, S.A.", "1968", "", "Filoextranjera"));
        ...
        b.add(new Book("Theodor W. Adorno", "Intervenciones Nueve modelos de crítica", "Monte Avila", "1969", "", "Filoextranjera"));
        b.add(new Book("Hans-Georg Gadamer", "El inicio de la filosofía occidental", "Paidos", "1995", "", "Filoextranjera"));
        b.add(new Book("Hans-Georg Gadamer", "La razón en la época de la ciencia", "Alfa", "1981", "", "Filoextranjera"));
        b.add(new Book("Theodor W. Adorno", "Sobre la metacrítica de la teoría del conocimiento", "Monte Avila", "1970", "", "Filoextranjera"));
        ...
        b.add(new Book("Maurice Merleau-Ponty", "Posibilidad de la filosofía", "Narcea, S.A.", "1979", "", "Filoextranjera"));
        b.add(new Book("Maurice Merleau-Ponty", "Lo visible y lo invisible", "Seix Barral", "1970", "", "Filoextranjera"));
        b.add(new Book("Maurice Merleau-Ponty", "Signos", "Seix Barral", "1964", "", "Filoextranjera"));
        b.add(new Book("Javier Sádaba", "La filosofía moral analítica De Wittgenstein a Tugendhat", "Mondadori", "1989", "", "Filoextranjera"));
        b.add(new Book("Luis M. Ravagnan", "Merleau-Ponty", "C.E. América L.", "1967", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz", "Los ocho pecados mortales de la humanidad civilizada", "Plaza Janés", "1973", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz", "Cuando el hombre encontró al perro", "Tusquets", "1975", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz", "Sobre la agresión: el pretendido mal", "Siglo XXI", "1971", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz", "Evolución y modificación de la conducta", "Siglo XXI", "1971", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz y Paul Leyhausen", "Biología del comportamiento", "Siglo XXI", "1971", "", "Filoextranjera"));
        b.add(new Book("Konrad Lorenz  Franz M. Wuketits", "La evolución del pensamiento", "Argos Vergara", "1984", "", "Filoextranjera"));
        b.add(new Book("René Girard", "El chivo expiatorio", "Anagrama", "1986", "", "Filoextranjera"));
        b.add(new Book("Yvon Belaval, Dirección de", "Historia de la filosofía Tomos 1 a 11 (1971/1981)", "Siglo XXI", "1971", "", "Filoextranjera"));
        b.add(new Book("Jacques Le Goff (Compilador)", "Herejías y sociedades en la Europa preind. S. XI-XVIII", "Siglo XXI", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("René Girard", "La ruta antigua de los hombres perversos", "Anagrama", "1989", "", "Filoextranjera"));
        ...
        b.add(new Book("Jürgen Moltmann", "Sobre la libertad, la alegría y el juego", "Sígueme", "1972", "", "Filoextranjera"));
        ...
        b.add(new Book("H. D. Lewis y R. Lawson Slater", "Religiones orientales y cristianismo", "Labor, S.A.", "1968", "", "Filoextranjera"));
        b.add(new Book("Hans Georg Gadamer", "La dialéctica de Hegel", "Cátedra", "1980", "", "Filoextranjera"));
        b.add(new Book("J. C. Friedrich Hölderlin", "Empédocles (teatro)", "Cantalapiedra", "1959", "", "Filoextranjera"));
        b.add(new Book("Mauro Wolf", "Sociologías de la vida cotidiana", "Cátedra", "1982", "", "Filoextranjera"));
        b.add(new Book("Immanuel Kant", "Primera introducción a la \"Crítica del juicio\"", "Visor", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("Richard Macksey/Eugenio Donato", "Los lenguajes críticos y las ciencias del hombre", "Barral", "1972", "", "Filoextranjera"));
        b.add(new Book("Martin Heidegger", "Qué es metafísica. Versión X. Zubiri", "Cruz del Sur", "1963", "Curz y Raya", "Filoextranjera"));
        ...
        b.add(new Book("Louis Althusser, J. Semprún y otros", "Polémica sobre marxismo y humanismo", "Siglo XXI", "1968", "", "Filoextranjera"));
        ...
        b.add(new Book("Martin Heidegger", "Interpretaciones sobre la poesía de Hölderlin", "Ariel", "1983", "", "Filoextranjera"));
        ...
        b.add(new Book("Gianni Vattimo y Pier Aldo Rovatti (Edrs.)", "El pensamiento débil", "Cátedra", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("Helena Cortés Gabandán", "Claves para una lectura de Hiperión", "Hiperión", "1996", "", "Filoextranjera"));
        ...
        b.add(new Book("Pierre Aubenque", "El problema del ser de Aristóteles", "Taurus", "1987", "Reimp.", "Filoextranjera"));
        b.add(new Book("Ludwig Wittgenstein", "Ocasiones filosóficas 1912-1951", "Cátedra", "1997", "", "Filoextranjera"));
        b.add(new Book("F. M. Cornford", "Sócrates y el pensamiento griego", "Norte y Sur", "1964", "", "Filoextranjera"));
        ...
        b.add(new Book("G. W. F. Hegel", "Lecciones sobre filosofía de la religión 1", "Alianza", "1984", "", "Filoextranjera"));
        b.add(new Book("G. W. F. Hegel", "Lecciones sobre filosofía de la religión 2 y 3", "Alianza", "1987", "", "Filoextranjera"));
        ...
        b.add(new Book("Octavi Piulats", "Antígona y Platón en el jóven Hegel", "Integral", "1989", "", "Filoextranjera"));
        b.add(new Book("Varios autores", "La concepción marxista del hombre", "Akal", "1978", "", "Filoextranjera"));
        b.add(new Book("Benjamin Farrington", "Ciencia y filosofía en la antigüedad", "Ariel", "1971", "", "Filoextranjera"));
        ...
        b.add(new Book("Ernst Bloch", "Avicena y la izquierda aristotélica", "Ciencia Nueva", "1966", "", "Filoextranjera"));
        b.add(new Book("Erasmo de Rotterdam", "Escritos de crítica religiosa y política", "C. Lectores", "1995", "", "Filoextranjera"));
        b.add(new Book("Marcel Detienne", "Dioniso a cielo abierto", "Gedisa", "1986", "", "Filoextranjera"));
        b.add(new Book("Eugenio Garin", "La revolución cultural del renacimiento", "Crítica", "1981", "", "Filoextranjera"));
        b.add(new Book("Charles S. Peirce", "El hombre, un signo", "Crítica", "1988", "", "Filoextranjera"));
        b.add(new Book("J. J. A. Bertrand", "Cervantes en el país de Fausto", "Cult. Hispánica", "1950", "", "Filoextranjera"));
        b.add(new Book("Cornelius Castoriadis", "La institución imaginaria de la sociedad Vol. 2", "Tusquest", "1989", "", "Filoextranjera"));
        ...
        b.add(new Book("Ludwig Wittgenstein", "Observaciones sobre los fundamentos de la matemática", "Alianza", "1987", "", "Filoextranjera"));
        b.add(new Book("Ludwig Wittgenstein", "Sobre la certeza", "Gedisa", "1988", "", "Filoextranjera"));
        b.add(new Book("Hanna Fenicgel Pitkin", " Wittgenstein: el lenguaje, la política y la justicia", "C. Est. Const.", "1984", "", "Filoextranjera"));
        b.add(new Book("Justus Hartnack", "Wittgenstein y la filosofía contemporánea", "Ariel", "1972", "", "Filoextranjera"));
        ...
        b.add(new Book("Joseph Rassam", "Introduc. a la filosofía de Sto. Tomás de Aquino", "Rialp", "1980", "", "Filoextranjera"));
        b.add(new Book("Josef Pieper", "El ocio y la vida intelectual", "Rialp", "1962", "", "Filoextranjera"));
        b.add(new Book("Vittorio Mathieu", "Temas y problemas de la filosofía actual", "Rialp", "1980", "", "Filoextranjera"));
        b.add(new Book("Gianfranco Dalmasso", "El lugar de la ideología", "Zero-Zix", "1978", "", "Filoextranjera"));
        b.add(new Book("Emile Poulat", "La crisis modernista (Historia, dogma, crítica)", "Taurus", "1974", "", "Filoextranjera"));
        b.add(new Book("J. J. Izurieta Craig", "Introducción a la filosofía T. I y II", "Guadalupe", "1972", "", "Filoextranjera"));
        b.add(new Book("José Ferrater Mora y otros", "Las filosofías de Ludwig Wittgenstein", "Oikos-tau", "1966", "", "Filoextranjera"));
        b.add(new Book("Cornelius Castoriadis", "Los dominios del hombre: las encrucijadas del lab.", "Gedisa", "1988", "", "Filoextranjera"));
        ...
        b.add(new Book("B. Zenkovsky", "Historia de la filosofía rusa T. I (fin entrada)", "Eudeba", "1953", "", "Filoextranjera"));
        ...
        b.add(new Book("Angel J. Cappelletti", "La filosofía de Heráclito de Efeso", "Monte Avila", "1969", "", "Filoextranjera"));
        b.add(new Book("Herbert Marcusse", "El final de la utopía", "Ariel", "1968", "", "Filoextranjera"));
        b.add(new Book("Willem L. Oltmans (compilador)", "Debate sobre el crecimiento", "F. C. E.", "1975", "", "Filoextranjera"));
        b.add(new Book("Michel Schmaus", "El problema escatológico", "Herder", "1964", "", "Filoextranjera"));
        b.add(new Book("J. L. Rodríguez García", "F. Hölderlin: El exilado en la tierra I y II", "Univ. Zaragoza", "1987", "", "Filoextranjera"));
        b.add(new Book("Wilhelm Waiblinger", "Vida, poesía y locura de Hölderlin", "Hiperión", "1988", "", "Filoextranjera"));
        b.add(new Book("David Hume", "Investigación sobre el conocimiento humano...", "C. Lectores", "1995", "", "Filoextranjera"));
        ...
        b.add(new Book("Giordano Bruno", "Expulsión de la bestia triunfante", "C. Lectores", "1995", "", "Filoextranjera"));
        b.add(new Book("Martin Heidegger", "Nietzsche Tomos I y II", "Destino", "2000", "", "Filoextranjera"));
        b.add(new Book("Jaime Labastida", "Producción,  ciencia y sociedad: de Descartes a Marx", "Siglo XXI", "1969", "", "Filoextranjera"));
        b.add(new Book("Rene Kraus", "La vida privada y pública de Sócrates", "Sudamericana", "1959", "", "Filoextranjera"));
        b.add(new Book("Alain", "El perro que tenía alma de hombre y otras pgs.", "Athenas", "1959", "Intonso", "Filoextranjera"));
        b.add(new Book("Giacomo Marramao", "Poder y secularización (en el lomo con \"i\")", "Península", "1989", "", "Filoextranjera"));
        b.add(new Book("S. Meliujin", "El problema de lo finito y lo infinito", "Grijalbo, S.A.", "1960", "Intonso", "Filoextranjera"));
        b.add(new Book("C. R. Badcock", "Levi-Strauss, el estruct.  y la teoría sociológica", "EFE", "1979", "", "Filoextranjera"));
        b.add(new Book("Ignacio Izusquiza", "Henri Bergson: La arquitectura del deseo", "Univ. Zaragoza", "1986", "", "Filoextranjera"));
        ...
        b.add(new Book("Pierre Klossowski", "Nietzsche y el círculo vicioso", "Seix Barral", "1972", "", "Filoextranjera"));
        b.add(new Book("Michel Foucault", "Nietzsche, la genealogía, la historia", "Pre-textos", "1988", "", "Filoextranjera"));
        b.add(new Book("Werner Ross", "F. Nietzsche El águila angustiada", "Paidos", "1994", "", "Filoextranjera"));
        b.add(new Book("Martin Heidegger", "Desde la experiencia del pensamiento", "Ediciones 62", "1986", "Trilingüe", "Filoextranjera"));
        ...
        b.add(new Book("Friedrich Nietzsche", "Schopenhauer como educador y otros textos", "C. Lectores", "1996", "", "Filoextranjera"));
    }
